...
@Component({
  selector: 'app-post-mention',
  templateUrl: './post-mention.component.html'
})

export class PostMentionComponent {
  ...
  addComment(event) {
    ...
    // console.log(charCode, event.shiftKey, this.isMentionUserSelect)
    if (charCode == 13 && event.shiftKey) {
      ...
      //this.apiService.sendTaskCommentData(commentText);
    }
  }
  modules = {
    mention: {
      ...
      source: (searchTerm, renderList) => {
        ...
        // console.log(this.mentionUsersList)
