...
const subActivity = mongoose.model('subActivities');

module.exports.logSubActivity = (main_activity_id, user_id, organization_id, workspace_id, application_id, record_id, task_id, activity_text, activity_type, activity_sub_type, uniqueId, invited_user_id, user_ids, avatar = undefined,activity_id=undefined,comment=undefined,comment_rich_link=undefined,post_id=undefined) => {
   // Return new promise 
    return new Promise((resolve, reject) => {
        let logActivity = new subActivity();
        logActivity.main_activity_id = main_activity_id;
